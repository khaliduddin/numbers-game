        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((number) => (
            <Toggle
              ...
              className={`h-6 w-6 sm:h-14 sm:w-14 text-lg sm:text-xl font-bold ${selectedNumber === number.toString() ? "bg-primary text-primary-foreground hover:bg-primary/80" : "hover:bg-gray-300"} data-[state=on]:bg-primary data-[state=on]:text-primary-foreground`}
